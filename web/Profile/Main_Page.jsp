 ...
 <!-- Container fluid  -->
     ...
     <%
      ...
      <div class="comment-widgets scrollable">
                                <!-- Comment Row -->
                                <form action='../hari1' method='post'enctype='multipart/form-data'>
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src='<%= rs.getPhoto()%>' alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                                       <br>
                                       <input type='text' name='post_t' placeholder='Write Something'>&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp 
                                         <input type='file' name='post_p'placeholder='ADD PHOTO' >&nbsp&nbsp&nbsp 
  ...
  <center></center>
                                           ...
                                           <!-- gggggggggggggggggggggggggggggggggg-->
                                            ...
                                            ResultSet rr=classes.register_class.Friend_List(id);
                                            while(rr.next()){
                                           
                                                ResultSet p=classes.register_class.Post(rr.getInt(1));
